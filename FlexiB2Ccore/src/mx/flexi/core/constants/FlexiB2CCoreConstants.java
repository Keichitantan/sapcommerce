 ...
 */
package mx.flexi.core.constants;

/**
 * Global class for all FlexiB2CCore constants. You can add global constants for your extension into this class.
 */
public final class FlexiB2CCoreConstants extends GeneratedFlexiB2CCoreConstants
{
	public static final String EXTENSIONNAME = "FlexiB2Ccore";


	private FlexiB2CCoreConstants()
	{
		//empty
	}
