...
<div class="col-md-12 spaceCard">
   <div class="row account-section-header ${noBorder}">
        <div class="col-xs-1 text-right"><img alt="Google_plus" width="30px" height="30px" src="${commonResourcePath}/images/iconos/WEB/UI icons/address-book.png"></div>
        <div class="col-xs-10"><spring:theme code="text.account.addressBook"/></div>
   </div>

   <div class="account-addressbook account-list">
        <div class="row">
            <div class=" col-xs-12 col-sm-6 col-md-4 card text-center addDirection">
                <ycommerce:testId code="addressBook_addNewAddress_button">
                    <div class="account-section-header-add">
                        <a href="add-address">
                            <img alt="mas" width="30px" height="30px" src="${commonResourcePath}/images/iconos/WEB/UI icons/mas.png"><br>
            ...
            <c:if test="${empty addressData}">
                <div class="col-xs-12 col-sm-6 col-md-8 card text-center account-section-content content-empty">
            ...
            <c:if test="${not empty addressData}">
                ...
                <c:set var="countCard" value="0" scope="page" />
   				<c:forEach items="${addressData}" var="address">
   				    <div class=" col-xs-12 col-sm-6 col-md-4 spaceCard">
   				    <c:set var="countCard" value="${countCard + 1}" scope="page"/>
   					<div class="card">
   						<ul class="pull-left">
   						    <li>
                                <strong>
                                    ...
                                    <c:choose>
                                        <c:when test="${address.defaultAddress}">
                                            <span class="text-gray"><spring:theme code="text.account.address"/> (<spring:theme code="text.default"/>)<span>
                                        </c:when>
                                        <c:otherwise>
                                            <spring:theme code="text.account.address"/> ${fn:escapeXml(countCard)}
                                        </c:otherwise>
                                    </c:choose>
                                </strong>
                            </li>
                                  ...
                                  <div class="col-xs-2 col-md-2 text-left">
                                       <ycommerce:testId code="addressBook_removeAddress_button">
                                           <a href="#" class="action-links removeAddressFromBookButton" data-address-id="${fn:escapeXml(address.id)}" data-popup-title="<spring:theme code="text.address.delete.popup.title" />">
                                               ...
                                               <img alt="Google_plus" width="25px" height="25px" src="${commonResourcePath}/images/iconos/WEB/UI icons/eliminar.png">
                                           </a>
                                       </ycommerce:testId>
                                  </div>
   						    </div>
