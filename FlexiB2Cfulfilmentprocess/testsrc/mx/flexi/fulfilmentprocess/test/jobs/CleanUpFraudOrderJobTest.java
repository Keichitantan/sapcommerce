 ...
 */
package mx.flexi.fulfilmentprocess.test.jobs;
...
import mx.flexi.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = FlexiB2CFulfilmentProcessConstants.ORDER_PROCESS_NAME;
